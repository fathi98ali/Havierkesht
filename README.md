...
در ادامه با استفاده از ابزارهایی مانند **Postman** و بخش **Network** مرورگر، تست‌های اولیه روی APIها انجام شد تا نحوه عملکرد، ساختار داده‌ها و مکانیزم احراز هویت مشخص شود.
...
در این مرحله تمامی صفحات سمت کاربر (User Side) سایت هاویر کشت به‌صورت کامل مورد بررسی قرار گرفتند تا مشخص شود هر صفحه برای دریافت یا ارسال داده‌ها از چه API هایی استفاده می‌کند.
